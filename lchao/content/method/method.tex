...
\begin{figure*}[t]
  \centering
  \hspace*{\fill}
  \subfloat[][]{\label{subfig:vol}\includegraphics[width=0.3\linewidth]{volume.png}} \hfill
  \subfloat[][]{\label{subfig:raw}\includegraphics[width=0.3\linewidth]{raw_crop_grey.png}} \hfill
  \subfloat[][]{\label{subfig:nlm}\includegraphics[width=0.3\linewidth]{nlm_crop_grey.png}}
  \hspace*{\fill}
...
\begin{figure*}[t]
  \centering
  \hspace*{\fill}
  \subfloat[][]{\label{subfig:lbp}\includegraphics[height=0.1\textheight]{lbp.png}} \hfill
  \subfloat[][]{\label{subfig:lbptop}\includegraphics[height=0.1\textheight]{LBPTOP_fig.png}}
  \hspace*{\fill}
